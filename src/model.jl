"""
    EMB.variables_flow_resource(m, 𝒩::Vector{<:Node}, 𝒫::Vector{<:ResourcePressure}, 𝒯, modeltype::EnergyModel)
    EMB.variables_flow_resource(m, 𝒩::Vector{<:Node}, 𝒫::Vector{<:ResourcePooling}, 𝒯, modeltype::EnergyModel)  
...
"""
function EMB.variables_flow_resource(m, 𝒩::Vector{<:Node}, 𝒫::Vector{<:ResourcePressure}, 𝒯, modeltype::EnergyModel) 
...
function EMB.variables_flow_resource(m, 𝒩::Vector{<:Node}, 𝒫::Vector{<:ResourcePooling{Any}}, 𝒯, modeltype::EnergyModel) 
...
""" 
    EMB.constraints_resource(m, n::EMB.Node, 𝒯, 𝒫::Vector{<:ResourcePressure}, modeltype::EnergyModel)
    EMB.constraints_resource(m, n::EMB.Node, 𝒯, 𝒫::Vector{<:ResourcePooling{Any}}, modeltype::EnergyModel)  
    EMB.constraints_resource(m, n::EMB.Node, 𝒯, 𝒫::Vector{<:ResourcePooling{ResourcePressure}}, modeltype::EnergyModel)
...
function EMB.constraints_resource(m, n::EMB.Node, 𝒯, 𝒫::Vector{<:ResourcePooling{Any}}, modeltype::EMB.EnergyModel) end
...
function EMB.constraints_resource(m, l::EMB.Link, 𝒯, 𝒫::Vector{<:ResourcePooling{Any}}, modeltype::EMB.EnergyModel) end
...
"""
    EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePressure}, 𝒯, modeltype::EMB.EnergyModel)
    EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePooling{Any}}, 𝒯, modeltype::EMB.EnergyModel)
    EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePooling{ResourcePressure}}, 𝒯, modeltype::EMB.EnergyModel)

Add blending and/or pressure related coupling constraints between nodes and links based on specific resource types.
"""
function EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePressure}, 𝒯, modeltype::EMB.EnergyModel)
    for n ∈ 𝒩
        constraints_pressure_couple(m, n, ℒ, 𝒯, 𝒫)
    end
end
function EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePooling{Any}}, 𝒯, modeltype::EMB.EnergyModel)
    for n ∈ 𝒩
...
function EMB.constraints_couple_resource(m, 𝒩::Vector{<:Node}, ℒ::Vector{<:Link}, 𝒫::Vector{<:ResourcePooling{ResourcePressure}}, 𝒯, modeltype::EMB.EnergyModel)
    for n ∈ 𝒩
        constraints_pressure_couple(m, n, ℒ, 𝒯, 𝒫)
    end
...
function EMB.create_link(m, l::CapDirect, 𝒯, 𝒫, modeltype::EMB.EnergyModel)
    ...
    EMB.constraints_opex_fixed(m, l, 𝒯, modeltype)
    EMB.constraints_opex_var(m, l, 𝒯, modeltype)
end
